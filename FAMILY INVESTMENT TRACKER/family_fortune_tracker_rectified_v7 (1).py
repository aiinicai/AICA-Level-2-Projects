...
==============================================================================
 ...
 HOW TO RUN:
     Recommended: python family_fortune_tracker_rectified_v4.py
     Alternative: streamlit run family_fortune_tracker_rectified_v4.py
...
APP_NAME = "Family Fortune Tracker"
...
def generate_template(member_names, broker_names):
    ...
    instructions = [
        "FAMILY FORTUNE TRACKER - UPLOAD TEMPLATE INSTRUCTIONS",
        "",
