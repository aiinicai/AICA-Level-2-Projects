...
export const DataReviewPanel: React.FC<DataReviewPanelProps> = ({
  ...
  const updateField = (section: keyof CompleteITRData, field: string, value: any) => {
    ...
    onChange(recalculateITR(updated));
  };
  ...
  const tabs = [
    ...
    { id: 'style', label: '5. Word Styles', icon: Palette },
  ] as const;
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-3 bg-slate-50 rounded border border-slate-200 space-y-2">
                ...
                <div className="flex justify-between text-xs">
                  <span className="text-slate-600">Tax on Total Income</span>
                  <input
                    type="text"
                ...
                <div className="flex justify-between text-xs">
                  <span className="text-slate-600">Less: Rebate 87A</span>
                  <input
                    type="text"
                    value={tax.rebate87A || ''}
                ...
                <div className="flex justify-between text-xs">
                  <span className="text-slate-600">Health & Edu Cess 4%</span>
                  <input
                    type="text"
                    value={tax.cess || ''}
              ...
              <div className="p-3 bg-slate-50 rounded border border-slate-200 space-y-2">
                <span className="text-xs font-bold text-slate-800 block">Taxes Paid / TDS</span>
                <div className="flex justify-between text-xs">
                  <span className="text-slate-600">TDS on Salary / Form 16</span>
                  <input
                    type="text"
                ...
                <div className="flex justify-between text-xs">
                  <span className="text-slate-600">TDS Non-Salary / 16A</span>
                  <input
                    type="text"
                ...
                <div className="flex justify-between text-xs">
                  <span className="text-slate-600">Advance / Self Tax</span>
                  <input
                    type="text"
