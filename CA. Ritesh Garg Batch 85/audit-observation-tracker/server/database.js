/**
 * database.js — WASM SQLite Database Layer for Audit Observation Tracker
 * Uses sql.js (WebAssembly SQLite) for cross-platform compatibility without C++ dependencies.
